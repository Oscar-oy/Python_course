        ...
        if currentNode.isLeaf(): #Leaf
            ...
            if currentNode.hasLeftChild():
                ...
                if currentNode.isLeftChild():
                    ...
                    currentNode.repalceNodeData(currentNode.rightChild.key, currentNode.rightChild.payload,currentNode.rightChild.leftChild, currentNode.rightChild.rightChild)
